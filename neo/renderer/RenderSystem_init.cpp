...
const char *r_rendererArgs[] = { "best", "arb", "arb2", NULL }; // old arb - Cowcat

idCVar r_inhibitFragmentProgram( "r_inhibitFragmentProgram", "0", CVAR_RENDERER | CVAR_BOOL, "ignore the fragment program extension" );
idCVar r_useLightPortalFlow( "r_useLightPortalFlow", "1", CVAR_RENDERER | CVAR_BOOL, "use a more precise area reference determination" );
idCVar r_multiSamples( "r_multiSamples", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "number of antialiasing samples" );
idCVar r_mode( "r_mode", "3", CVAR_ARCHIVE | CVAR_RENDERER | CVAR_INTEGER, "video mode number" ); // was 5 - Cowcat
...
idCVar r_useTripleTextureARB( "r_useTripleTextureARB", "0", CVAR_RENDERER | CVAR_BOOL, "cards with 3+ texture units do a two pass instead of three pass" ); // Cowcat
idCVar r_usedrawinteraction0( "r_usedrawinteraction0", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL, "Morphos gfx workaround" ); // Cowcat
...
idCVar r_skipFogLights( "r_skipFogLights", "1", CVAR_RENDERER | CVAR_BOOL | CVAR_ARCHIVE, "skip all fog lights" ); // Cowcat - issues
...
idCVar r_shadows( "r_shadows", "0", CVAR_RENDERER | CVAR_BOOL  | CVAR_ARCHIVE, "enable shadows" ); // Cowcat
...
#define QGLPROC(name, rettype, args) \
	...
	if (!q##name) \
		common->Printf("OpenGL not found(%s)\n", #name);
#else
#define QGLPROC(name, rettype, args) \
	q##name = (rettype(APIENTRYP)args)GLimp_ExtensionPointer(#name); \
	if (!q##name) \
